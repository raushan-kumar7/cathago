...
adminRouter.route("/credit-requests/process").post(isAdmin, processCreditRequest);
adminRouter.route("/documents").get(isAdmin, listDocuments).delete(isAdmin, deleteDocument)
